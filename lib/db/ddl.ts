/**
 * Schema do banco em SQL, idempotente. Espelha `schema.ts` e roda na abertura
 * da conexão.
 *
 * Mantido como constante (e não como arquivo lido em runtime) para o app
 * empacotado não depender do layout de pastas do build. Para gerar migrations
 * de verdade com o drizzle-kit, a fonte continua sendo `schema.ts`.
 */
